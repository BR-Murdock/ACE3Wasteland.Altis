...
T8_fnc_ActionLaptop =
{
	...
	default
	{
		{    
			...
			player setVariable ["cmoney", (player getVariable ["cmoney", 0]) + 1250000, true];
			[] spawn fn_savePlayerData;
			systemChat format["You have hacked players bank accounts to the value of $1250,000"];				
				};
			};
