...
_blueMenArray = ["B_Soldier_02_f","B_Soldier_03_f"];
_blueMenArray2 = ["B_Soldier_02_f","B_Soldier_03_f"];
_blueMenArray3 = ["B_Soldier_02_f","B_Soldier_03_f"];
_BLUarrays = [_blueMenArray,_blueMenArray2,_blueMenArray3];
_redMenArray = ["O_Soldier_A_F","O_medic_F"];
_redMenArray2 = ["O_Soldier_A_F","O_medic_F"];
_OPFarrays = [_redMenArray,_redMenArray2];
_greenMenArray = ["I_G_Soldier_A_F","I_G_Soldier_lite_F"];
