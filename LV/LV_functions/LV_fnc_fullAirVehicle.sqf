...
_BLUveh = ["B_Heli_Light_01_F",B_Heli_Light_01_armed_F,"B_Heli_Light_01_stripped_F","B_Heli_Transport_01_F","B_Heli_Transport_01_camo_F"];
_OPFveh = ["O_Heli_Light_02_F","O_Heli_Light_02_unarmed_F"];
_INDveh = ["I_Heli_Transport_02_F","I_Heli_light_03_F","I_Heli_light_03_unarmed_F"];
