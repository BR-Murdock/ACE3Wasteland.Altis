...
//-----------------------------
//EAST-Los Pepes-----------------------------
JSHK_weaponArrEast = ["arifle_MX_Hamr_pointer_F","arifle_MXC_Holo_pointer_F","arifle_MXM_Hamr_pointer_F","arifle_MXC_ACO_pointer_F","srifle_EBR_MRCO_LP_BI_F"];
JSHK_uniformArrEast = ["TRYK_shirts_BLK_PAD","TRYK_shirts_BLK_PAD_BK","TRYK_shirts_PAD_YEL","TRYK_T_BLK_PAD"];
JSHK_vestArrEast = ["TRYK_V_ArmorVest_Delta", "TRYK_V_ArmorVest_HRT_OD", "TRYK_V_tacv1_P_BK"];
JSHK_headArrEast = ["TRYK_H_headsetcap_blk","TRYK_H_headsetcap_blk_Glasses","TRYK_H_headsetcap_od_Glasses","TRYK_R_CAP_BLK","TRYK_r_cap_blk_Glasses"];
JSHK_goggleArrEast = ["TRYK_Beard_BK","TRYK_Beard_Gr2","G_Aviator","G_Balaclava_blk","G_Lowprofile","G_Balaclava_combat","G_Spectacles_Tinted"];
JSHK_backpackArrEast = ["TRYK_B_AssaultPack_MARPAT_Wood","TRYK_B_Kitbag_blk","TRYK_B_Medbag","TRYK_B_tube_cyt","TRYK_B_Alicepack","TRYK_B_BAF_BAG_CYT"];
//-----------------------------
//GUER-Medellin-----------------------------
JSHK_weaponArrGuer = ["arifle_MX_Hamr_pointer_F","arifle_MXC_Holo_pointer_F","arifle_MXM_Hamr_pointer_F","arifle_MXC_ACO_pointer_F","srifle_EBR_MRCO_LP_BI_F"];
JSHK_uniformArrGuer = ["TRYK_shirts_BLK_PAD","TRYK_shirts_BLK_PAD_BK","TRYK_shirts_PAD_YEL","TRYK_T_BLK_PAD"];
JSHK_vestArrGuer = ["TRYK_V_ArmorVest_Delta", "TRYK_V_ArmorVest_HRT_OD", "TRYK_V_tacv1_P_BK"];
JSHK_headArrGuer = ["TRYK_H_headsetcap_blk","TRYK_H_headsetcap_blk_Glasses","TRYK_H_headsetcap_od_Glasses","TRYK_R_CAP_BLK","TRYK_r_cap_blk_Glasses"];
JSHK_goggleArrGuer = ["TRYK_Beard_BK","TRYK_Beard_Gr2","G_Aviator","G_Balaclava_blk","G_Lowprofile","G_Balaclava_combat","G_Spectacles_Tinted"];
JSHK_backpackArrGuer = ["TRYK_B_AssaultPack_MARPAT_Wood","TRYK_B_Kitbag_blk","TRYK_B_Medbag","TRYK_B_tube_cyt","TRYK_B_Alicepack","TRYK_B_BAF_BAG_CYT"];
//-----------------------------
