...
_setupObjects =
{
	...
	_vehicleName = "Laptop";
	_missionHintText = format ["Paramilitary awaits a <t color='%2'>money transfer</t>. Kill the armed forces, hack the laptop and take this drugmoney!", _vehicleName, mainMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Bad day for Columbian Military. They lost lots of Dollars today. Good job!"];
};
