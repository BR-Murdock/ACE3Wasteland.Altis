...
_setupObjects =
{
	...
	_missionHintText = format ["Guerillas using <t color='%2'>%1</t> to carry weapons! Stop them!", _vehicleName, mainMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Blackjack! The convoi has been stopped.";
};
