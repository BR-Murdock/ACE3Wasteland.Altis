...
//	@file Author: JoSchaap, AgentRev, GriffinZS, RickB
...
_setupObjects =
{
	...
	_obj2 = createVehicle ["Land_ChairWood_F", _missionPos,[], 10,"None"]; 
	...
	_missionHintText = format ["Columbian soldiers captured <t color='%2'>unknown persons</t>. Kill the soldiers and free the persons!", _vehicleName, mainMissionColor];
};
...
_failedExec =
{
	...
	_failedHintMessage = format ["Die Geisel ist tot! Was GENAU habt ihr bei dem Auftrag nicht verstanden?!"];
};
...
_successExec =
{
	...
	_successHintMessage = format ["What a mess! The captured persons were just civilians. God damnit! Anyway, good job, dudes!"];
};
