...
_setupVars =
{
	_missionType = "Columbian Conference";
...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>Columbian Military meets at<br/><t color='%1'>%2</t>! <br/>Spotters talk about <t color='%1'>%3 enemies.</t>.<br/>Clear this area!", sideMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Good work!<br/><t color='%1'>%2</t> has been cleared, the conference cancelled.", sideMissionColor, _townName];
