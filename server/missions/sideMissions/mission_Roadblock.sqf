...
_setupObjects =
{
	...
	_missionHintText = format ["Military forces built up a roadblock and controlling every vehicle. Stop this!", sideMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Good work! The roadblock has been cleared."];
};
