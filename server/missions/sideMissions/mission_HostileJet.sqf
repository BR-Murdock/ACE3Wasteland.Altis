...
_setupVars =
{
	_missionType = "Wannabe Skyfighter";
...
_setupObjects =
{
	...
	_missionHintText = format ["A bloody noob is trying to fly a <t color='%2'>%1</t> and terrorize Altis. Stop this wanker!", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Well done! This wanker will not fly again! Take the crates and money.";
};
