...
_setupVars =
{
	_missionType = "Columbian Headquarter";
...
_setupObjects =
{
	...
	_missionHintText = format ["Columbians try to build a headquarter in <br/><t size='1.25' color='%1'>%2</t>.<br/>Spotters talk about <t color='%1'>%3 soldiers</t>, hiding inside houses. Kill them all!", sideMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Good Job! <t color='%1'>%2</t> won't be a Columbian headquarter.<br/>Save the crates!", sideMissionColor, _townName];
