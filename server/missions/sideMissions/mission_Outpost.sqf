...
_setupVars =
{
	_missionType = "Paramilitary Outpost";
...
_setupObjects =
{
	...
	_missionHintText = format ["Columbian Paramilitary tries to build an <t color='%1'>outpost</t>. Kill the armed forces and burn down this outpost!", sideMissionColor]
};
...
_successExec =
{
	...
	_successHintMessage = "Good job! The outpost does not exist anymore!";
};
