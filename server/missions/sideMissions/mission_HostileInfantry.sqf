...
_setupVars =
{
	_missionType = "Paramilitary Hideout";
...
_setupObjects =
{
	...
	_missionHintText = format ["Paramilitary was spotted in <br/><t color='%1'>%2</t>!<br/>Rumors talk about <t color='%1'>%3 enemies</t>. <br/>Kick their asses back to Bogota!", sideMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Good job!<br/><br/><t color='%1'>%2</t> is free again!<br/>Crates are yours. Pick them up!", sideMissionColor, _townName];
