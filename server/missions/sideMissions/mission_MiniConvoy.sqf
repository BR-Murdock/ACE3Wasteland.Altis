...
_setupVars =
{
	_missionType = "Weapons on Wheels";
...
_setupObjects =
{
	...
	{
		["B_MRAP_01_gmg_F", "B_Truck_01_ammo_F", "B_MRAP_01_hmg_F"]
	}
	else
	{
		[
	...
	_missionHintText = format ["A <t color='%2'>%1</t> was spotted, escorted by armed vehicles. Kill them all and get the weapons!", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Good job! Weapons and not destroyed vehicles are yours.";
};
