...
_setupObjects =
{
	...
	_missionHintText = format ["A Columbian Squad has been spotted! Go there and eliminate them!", sideMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Well done! The Columbian Squad has been liquidated."];
};
