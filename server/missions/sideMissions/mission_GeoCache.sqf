...
_setupObjects =
{
	...
	_missionHintText = "Columbian Paras await Air Supply. Go there, find the radio around this area and pick up the supply before they do!";
};
...
_successExec =
{
	...
	_randomCase = ["I_CargoNet_01_ammo_F","O_CargoNet_01_ammo_F","B_CargoNet_01_ammo_F"] call BIS_fnc_selectRandom;
	...
	_successHintMessage = "The Air Supply was delivered. Good job!";
};
