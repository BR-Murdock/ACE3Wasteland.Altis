...
_setupObjects =
{
	...
	_missionHintText = "A chopper went down! Kill the crew and save the cargo!";
};
...
_successExec =
{
	...
	_successHintMessage = "Cargo of crashed chopper was saved. Good work!";
};
