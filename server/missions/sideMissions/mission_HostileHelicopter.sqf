...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%2'>%1</t>, also known as THE HUNTER, was spotted. Prepare to die, scumbag!", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Not bad, scumbag! The Hunter went down!";
};
