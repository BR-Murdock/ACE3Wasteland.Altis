...
_setupObjects =
{
	...
	_smugglerVeh = ["B_APC_Tracked_01_AA_F","B_APC_Wheeled_01_cannon_F","I_APC_tracked_03_cannon_F"] call BIS_fnc_selectRandom; 
	...
	_boxes1 = ["Box_IND_AmmoVeh_F","Box_East_AmmoVeh_F","Box_NATO_AmmoVeh_F"];
	...
	_boxes2 = ["Box_IND_WpsLaunch_F","Box_East_WpsLaunch_F","Box_NATO_WpsLaunch_F"];
	...
	_missionHintText = format ["A drugmarket has been spotted! Go there, kill the wankers and get the drugs out of there!", sideMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Good job! These damn businessmen now eat shit!"];
};
