...
_setupObjects =
{
	...
	_convoyVeh = ["B_APC_Wheeled_01_cannon_F","O_APC_Wheeled_02_rcws_F","B_Truck_01_fuel_F","B_APC_Wheeled_01_cannon_F","O_APC_Wheeled_02_rcws_F"];
	...
	_missionHintText = format ["Columbian government ordered to bring plenty of drugs out of Altis. Stop the projekt!",  moneyMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Good job! The export has been stopped!";
};
