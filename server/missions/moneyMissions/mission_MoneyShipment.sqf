...
_setupVars =
{
	...
	[
		// Easy
		[
			"Small Drug Shipment", // Marker text
			10000, // Money
			[
				[ // NATO convoy
				...
				[ // AAF convoy
					...
					["I_MRAP_03_hmg_F", "I_APC_tracked_03_cannon_F"] // Veh 2
				]
			]
		],
		// Medium
		[
			"Medium Drug Shipment", // Marker text
			15000, // Money
			[
				[ // NATO convoy
					["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"], // Veh 1
		...
		// Hard
		[
			"Large Drug Shipment", // Marker text
			20000, // Money
			[
				[ // NATO convoy
		...
		// Extreme
		[
			"Heavy Drug Shipment", // Marker text
			30000, // Money
			[
				[ // NATO convoy
...
_setupObjects =
{
	...
	_missionHintText = format ["A convoi with plenty of drugs and <t color='%1'>%2</t> are on the way, escorted by <t color='%1'>%3</t>.<br/>Stop this convoi!", moneyMissionColor, _moneyText, _vehicleName];
...
_successExec =
{
	...
	_successHintMessage = "Good work! The convoi has been stopped!";
};
